...
/*    //ColumnInfo可以更改映射到数据表中的名字,
    ...
    //当Cache类写入数据库时，User类中的字段可以映射到Cache中
//    @Embedded
//    public User user;

    //mDate在写入数据库时会被DateConverter类中方法转为long类型，从数据库读取时被DateConverter类中方法转为Date类型
